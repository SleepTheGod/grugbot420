...
grow_lobe("lobe_math", [
    ("what is addition", "calculate^5 | explain^3",
     ...
     ["addition","number","rock","sum","four"], 6.5, E()),
    ("how do i add numbers", "explain^5 | calculate^3",
     ...
     ["addition","add","number","pile","count"], 6.0, E()),
    ("what is subtraction", "explain^5 | calculate^4",
     ...
     ["subtraction","minus","take","fewer","number"], 5.8, E()),
    ("what is multiplication", "calculate^5 | explain^4",
     ...
     ["multiply","times","group","product","number"], 5.5, E()),
    ("what is division", "explain^5 | calculate^4",
     ...
     ["division","divide","share","equal","fair"], 5.5, E()),
    ("what is a fraction", "explain^5 | clarify^3",
     ...
     ["fraction","half","part","piece","whole"], 5.0, E()),
    ...
    ("what is geometry", "explain^5 | describe^4",
     ...
     ["geometry","shape","circle","triangle","angle"], 6.0, E()),
    ...
    ("what is nothingness", "explain^5 | ponder^3",
     ...
     ["zero","none","empty","nothing","number"], 5.0, E()),
])
...
grow_lobe("lobe_science", [
    ...
    ("what is energy", "explain^5 | define^4",
     ...
     ["energy","power","heat","motion","force"], 7.0, E()),
    ("what is an atom", "define^5 | explain^4",
     ...
     ["atom","tiny","particle","matter","stuff"], 6.8, E()),
    ("why does the sky look blue", "explain^5 | reason^3",
     ...
     ["sky","blue","light","color","sun"], 6.0, E()),
    ("what is electricity", "explain^5 | define^3",
     ...
     ["electricity","charge","flow","lightning","power"], 6.5, E()),
    ("how does sound travel", "explain^5 | describe^3",
     ...
     ["sound","air","wave","vibration","ear"], 6.0, E()),
    ("what is heat", "explain^5 | define^3",
     ...
     ["heat","hot","temperature","fire","cold"], 6.0, E()),
...
grow_lobe("lobe_biology", [
    ("what is evolution", "explain^5 | reason^4",
     ...
     ["evolution","change","survive","trait","species"], 7.0, E()),
    ("what is a cell", "define^5 | explain^4",
     ...
     ["cell","body","living","brick","tiny"], 6.5, E()),
    ("what is dna", "explain^5 | define^3",
     ...
     ["dna","recipe","gene","cell","parent"], 6.8, E()),
    ("how do plants make food", "explain^5 | describe^4",
     ...
     ["plant","sunlight","leaf","food","sugar"], 7.0, E()),
    ("what is the brain", "explain^5 | describe^4",
     ...
     ["brain","think","memory","head","mind"], 6.5, E()),
    ("why do we need blood", "explain^5 | reason^3",
     ...
     ["blood","heart","body","carry","alive"], 6.0, E()),
...
grow_lobe("lobe_phil", [
    ...
    ("what is truth", "ponder^5 | reason^4 | define^3",
     ...
     ["truth","real","fact","world","match"], 6.5, E()),
    ...
    ("what is good and evil", "ponder^5 | reason^4",
     ...
     ["good","evil","right","wrong","ethics"], 6.0, E()),
...
grow_lobe("lobe_surv", [
    ...
    ("how do i stay safe", "explain^5 | caution^4",
     ...
     ["safe","safety","protect","watch","tribe"], 6.5, E()),
    ("should i fight or flee", "reason^5 | caution^4",
     ...
     ["fight","flee","run","enemy","decide"], 6.5, E()),
    ...
    ("how do i make fire", "explain^5 | describe^4",
     ...
     ["fire","spark","wood","warmth","light"], 6.0, E()),
    ("how do i find shelter", "explain^5 | describe^3",
     ...
     ["shelter","cave","dry","warm","safe"], 5.5, E()),
])
...
grow_lobe("lobe_emp", [
    ...
    ("i am angry and frustrated", "validate^5 | comfort^4 | reassure^3",
     ...
     ["anger","angry","frustration","hot","calm"], 6.0, E()),
    ("how do i comfort someone", "explain^5 | support^4",
     ...
     ["comfort","listen","presence","support","care"], 6.0, E()),
...
grow_lobe("lobe_crea", [
    ...
    ("how do i make music", "explain^5 | describe^4",
     ...
     ["music","drum","rhythm","melody","sound"], 6.0, E()),
    ("describe a beautiful painting", "describe^5 | elaborate^4",
     ...
     ["painting","color","art","beauty","picture"], 5.5, E()),
    ("what if i could imagine anything", "ponder^5 | elaborate^4",
     ...
     ["imagine","dream","create","mind","wonder"], 6.0, E()),
    ("i want to create something", "elaborate^5 | support^4",
     ...
     ["create","make","build","craft","new"], 6.0, E()),
    ("tell me a story", "elaborate^6 | describe^4",
     ...
     ["story","tale","hunter","beast","wisdom"], 6.5, E()),
])
...
grow_lobe("lobe_social", [
    ...
    ("you are my friend", "acknowledge^5 | reassure^4",
     ...
     ["friend","trust","bond","tribe","loyal"], 7.0, E()),
    ("can i trust you", "reassure^6 | validate^4",
     ...
     ["trust","loyal","honest","word","friend"], 6.5, E()),
    ("how do i make friends", "explain^5 | support^4",
     ...
     ["friend","kind","share","listen","bond"], 6.0, E()),
    ("lets work together", "acknowledge^5 | welcome^4",
     ...
     ["cooperate","together","team","tribe","share"], 6.0, E()),
    ("i need help with something", "support^6 | acknowledge^4",
     ...
     ["help","support","need","aid","tribe"], 6.5, E()),
])
...
grow_lobe("lobe_nature", [
    ("tell me about the forest", "describe^5 | explain^4",
     ...
     ["forest","tree","green","beast","wood"], 6.0, E()),
    ("describe the ocean", "describe^5 | explain^4",
     ...
     ["ocean","water","wave","fish","salt"], 6.0, E()),
    ...
    ("what makes the weather", "explain^5 | reason^4",
     ...
     ["weather","rain","cloud","wind","storm"], 5.5, E()),
    ("why do rivers flow", "explain^5 | reason^3",
     ...
     ["river","flow","water","downhill","valley"], 5.5, E()),
...
grow_lobe("lobe_tech", [
    ("how do computers work", "explain^5 | describe^4",
     ...
     ["computer","machine","switch","think","data"], 6.5, E()),
    ("what is the internet", "explain^5 | define^3",
     ...
     ["internet","wire","network","message","connect"], 6.0, E()),
    ("what is a robot", "define^5 | describe^4",
     ...
     ["robot","machine","move","task","rule"], 6.0, E()),
...
grow_lobe("lobe_food", [
    ("how do i cook meat", "explain^5 | describe^4",
     ...
     ["cook","meat","fire","food","hot"], 6.0, E()),
    ("what should i eat", "explain^5 | support^3",
     "Grug. Eat question. Grug eat meat for strength, fruit for sweet, root for full belly, water for life. Eat many kinds. Body need different things to stay strong.",
     ["eat","food","meat","fruit","strength"], 5.5, E()),
    ("i am very hungry", "support^5 | acknowledge^4",
     ...
     ["hungry","food","share","belly","eat"], 6.0, Dict{String,Any}("voice_register"=>"warm")),
    ("how do i find clean water", "explain^5 | caution^4",
     ...
     ["water","drink","clean","stream","boil"], 6.0, E()),
