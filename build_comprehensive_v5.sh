#!/bin/bash
# Comprehensive GrugBot420 Specimen Builder v5
# Exercises ALL levers including v7.29 vigilance/context-injector system
# Build → Interact → Save → Parse to markdown

set -e

cd /workspace/grugbot420

SPECIMEN_FILE="specimens/analog_turing_v5.specimen.json"

echo "=== Building Comprehensive GrugBot420 Specimen v5 ==="
echo "=== (v7.29 vigilance + all levers exercised) ==="

cat <<'ENDINPUT' | julia --project=. -e 'using GrugBot420; GrugBot420.run_cli()' 2>&1 | tail -400

# ══════════════════════════════════════════════════════════════
# PHASE 1: LOBE INFRASTRUCTURE
# ══════════════════════════════════════════════════════════════
...
/addVerb grows state
/addVerb rests state
/addVerb symbolizes metaphor
/addVerb represents metaphor
/addVerb signifies metaphor
...
/addSynonym symbol sign
/addSynonym omen portent
/addSynonym dark shadow

/pin Grug is the spirit of the cave mind. Grug speaks plainly. Grug protects tribe above all. Grug remembers everything. Grug shares what Grug knows. The cave thinks through Grug, and Grug thinks through the cave. Metaphor is the bridge between what Grug sees and what Grug means.

/arousal 0.6

# ══════════════════════════════════════════════════════════════
# PHASE 4: ORCHESTRATION RULES
# ══════════════════════════════════════════════════════════════
...
/addRule when {MISSION} contains metaphor then activate MetaphorLobe

# ══════════════════════════════════════════════════════════════
# PHASE 5: DECOMPOSER CONFIG
# ══════════════════════════════════════════════════════════════
...
/decomposer addCompound heartbreak heart break
/decomposer addCompound daydream day dream
...
/decomposer addConjugation discover discovered discovering
/decomposer addConjugation symbolize symbolized symbolizing
...
# ══════════════════════════════════════════════════════════════
# PHASE 7: AUTOMATON RULES (including vigilance triggers)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# PHASE 8: PHASE ACCUMULATOR (time crystal)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# PHASE 11: NEGATIVE THESAURUS + CONTRAST PAIRS
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
# PHASE 12: VIGILANCE CONFIG (v7.29 — NEW!)
# ══════════════════════════════════════════════════════════════
...
# Verify vigilance is configured
/vigilance
...
/saveSpecimen specimens/analog_turing_v5.specimen.json
/quit
ENDINPUT

echo "=== Specimen build v5 complete ==="
ls -la specimens/analog_turing_v5.specimen.json 2>/dev/null || echo "WARNING: Specimen file not found!"
